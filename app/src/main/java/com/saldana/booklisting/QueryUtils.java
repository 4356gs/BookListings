...
import static com.saldana.booklisting.BookListingActivity.LOG_TAG;
...
public final class QueryUtils {
     ...
     */
//    public static ArrayList<BookListing> extractBooks() {
//
...
//                String actualAuthor = authorsArray.getString(0);
//                BookListing booklisting = new BookListing(title, actualAuthor,publishedDate);
...
//    }
    ...
    private static List<BookListing> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                String publishedDate = volumeInfo.getString("publisher");
    ...
    public static List<BookListing> fetchEarthquakeData(String requestUrl) {
        ...
        List<BookListing> BookListing = extractFeatureFromJson(jsonResponse);
